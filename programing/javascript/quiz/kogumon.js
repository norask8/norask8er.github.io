$(function(){
    ...
    aryQuiz.push(
        {
            question : 'こぐもんだい/L39.jpg',
            answer : ['L-39', 'A-4', 'AMX', 'F-5']
        }
        ,{
            question : 'こぐもんだい/M346.jpg',
            answer : ['M-346', 'Yak-130', 'T-4', 'T-50']
        }
        ,{
            question : 'こぐもんだい/ミラージュ3.jpg',
            answer : ['ミラージュⅢ', 'ミラージュ2000', 'クフィル', 'JAS-39']
        }
        ,{
            question : 'こぐもんだい/バンパイア.jpg',
            answer : ['バンパイア', 'シービクセン', 'A-37', 'F-101']
        }
        ,{
            question : 'こぐもんだい/F-18C.jpg',
            answer : ['F/A-18C', 'YF-17', 'F/A-18E', 'E/A-18G']
        }
        ,{
            question : 'こぐもんだい/Su-27SM3.jpg',
            answer : ['Su-27SM3', 'Su-35S', 'Su-27S', 'Su-35']
        }
        ,{
            question : 'こぐもんだい/Su-27KUB.jpg',
            answer : ['Su-27KUB', 'Su-34', 'Su-32', 'Su-30MK']
        }
        ,{
            question : 'こぐもんだい/J-10A.jpg',
            answer : ['J-10A', 'EF-2000', 'MiG-1.44', 'J-10B']
        }
        ,{
            question : 'こぐもんだい/シュペルエタンダール.jpg',
            answer : ['シュペルエタンダール', 'エタンダールⅣ', 'G-4', 'ミラージュⅤ']
        }
        ,{
            question : 'こぐもんだい/Tu-160.jpg',
            answer : ['Tu-160', 'コンコルド', 'Tu-144', 'B-1B']
        }
    );
