...
$(function(){
    ...
    var quiz_fin_cnt = 18; //何問で終了か設定（クイズ数以下であること）
    ...
    aryQuiz.push(
        {
            ...
            answer : ['F-15', 'F-2', 'F-16', 'F-22']
        }
        ,{
            question : 'airplane/f-35.jpg',
            answer : ['F-35', 'F-22', 'F-16', 'F-22']
        }
        ,{
